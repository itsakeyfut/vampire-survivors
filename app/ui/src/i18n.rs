...
pub fn t(key: &'static str, lang: Language) -> &'static str {
    match (key, lang) {
        ...
        ("shop_char_magician", Language::Japanese) => "マジシャン (500G)",
        ("shop_char_magician", Language::English) => "Magician (500G)",
        ("shop_char_thief", Language::Japanese) => "シーフ (500G)",
        ("shop_char_thief", Language::English) => "Thief (500G)",
        ("shop_char_knight", Language::Japanese) => "ナイト (1000G)",
        ("shop_char_knight", Language::English) => "Knight (1000G)",
        ("shop_upgrade_hp", Language::Japanese) => "+最大HP (300G)",
        ("shop_upgrade_hp", Language::English) => "+Max HP (300G)",
        ("shop_upgrade_speed", Language::Japanese) => "+移動速度 (300G)",
        ("shop_upgrade_speed", Language::English) => "+Speed (300G)",
        ("shop_upgrade_damage", Language::Japanese) => "+攻撃力 (300G)",
        ("shop_upgrade_damage", Language::English) => "+Damage (300G)",
        ("shop_upgrade_xp", Language::Japanese) => "+XP取得 (300G)",
        ("shop_upgrade_xp", Language::English) => "+XP Gain (300G)",
        ("shop_upgrade_weapon", Language::Japanese) => "+開始武器 (500G)",
        ("shop_upgrade_weapon", Language::English) => "+Starting Weapon (500G)",
