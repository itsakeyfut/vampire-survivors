...
pub fn t(key: &'static str, lang: Language) -> &'static str {
    match (key, lang) {
        ...
        // ── Stage select screen ───────────────────────────────────────────
        ("stage_select_title", Language::Japanese) => "ステージ選択",
        ("stage_select_title", Language::English) => "Select Stage",
        ("stage_mad_forest", Language::Japanese) => "狂乱の森",
        ("stage_mad_forest", Language::English) => "Mad Forest",
        ("stage_inlaid_library", Language::Japanese) => "装飾図書館",
        ("stage_inlaid_library", Language::English) => "Inlaid Library",
        ("stage_dairy_plant", Language::Japanese) => "乳製品工場",
        ("stage_dairy_plant", Language::English) => "Dairy Plant",
        ("stage_difficulty_easy", Language::Japanese) => "難易度: 易しい",
        ("stage_difficulty_easy", Language::English) => "Difficulty: Easy",
        ("stage_difficulty_medium", Language::Japanese) => "難易度: 普通",
        ("stage_difficulty_medium", Language::English) => "Difficulty: Medium",
        ("stage_difficulty_hard", Language::Japanese) => "難易度: 難しい",
        ("stage_difficulty_hard", Language::English) => "Difficulty: Hard",
        ("btn_select_stage", Language::Japanese) => "このステージで開始",
        ("btn_select_stage", Language::English) => "Start Stage",
        ("stage_enemies_label", Language::Japanese) => "登場する敵",
        ("stage_enemies_label", Language::English) => "Enemies",
        ("stage_hp_label", Language::Japanese) => "敵HP",
        ("stage_hp_label", Language::English) => "Enemy HP",
        ("stage_speed_label", Language::Japanese) => "敵速度",
        ("stage_speed_label", Language::English) => "Enemy Speed",
