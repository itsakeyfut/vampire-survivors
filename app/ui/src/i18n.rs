...
pub fn t(key: &'static str, lang: Language) -> &'static str {
    match (key, lang) {
        ...
        ("label_unlock_cost_prefix", Language::Japanese) => "解放には",
        ("label_unlock_cost_prefix", Language::English) => "Requires",
        ("label_unlock_cost_suffix", Language::Japanese) => "G 必要",
        ("label_unlock_cost_suffix", Language::English) => "G to unlock",
...
mod tests {
    ...
    fn all_keys_non_empty() {
        let keys = [
            ...
            "btn_start_with_char",
            "label_locked",
            "label_unlock_cost_prefix",
            "label_unlock_cost_suffix",
            "label_hp",
            "label_speed",
            "label_weapon",
            "weapon_whip",
